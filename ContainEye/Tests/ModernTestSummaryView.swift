...
struct ModernTestSummaryView: View {
...
#Preview {
    ...
    return VStack(spacing: 16) {
        ModernTestSummaryView(test: test1.liveModel)
        ModernTestSummaryView(test: test2.liveModel)
        ModernTestSummaryView(test: test3.liveModel)
    }
    .padding()
