...
#Preview {
    ServerTestDetail(test: BlackbirdLiveModel<ServerTest>(ServerTest(id: Int.random(in: (.min)...(Int.max)), title: "Title", credentialKey: "-", command: "curl localhost", expectedOutput: ".+", status: .notRun)))
}
